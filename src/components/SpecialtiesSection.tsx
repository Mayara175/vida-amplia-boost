...
import { Activity, Brain, Syringe, HeartPulse, Zap, ShieldCheck } from "lucide-react";
...
const fisiatriaItems = [
  ...
  { icon: Syringe, text: "Toxina Botulínica e procedimentos invasivos" },
...
const neurologiaItems = [
  ...
  { icon: Zap, text: "Cefaleia, Epilepsia e distúrbios do equilíbrio" },
