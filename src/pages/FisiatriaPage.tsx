            ...
            >
              <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
                ...
                <div className="absolute -bottom-3 -left-3 md:-bottom-4 md:-left-4 bg-card rounded-xl md:rounded-2xl p-3 md:p-4 shadow-xl border border-border hidden sm:block">
                  ...
                  <p className="text-base md:text-lg font-display font-bold text-foreground">Fisiatria</p>
                </div>
              </div>
            </motion.div>
          </div>
              ...
              {credentials.map((c) => (
                <div key={c.text} className="flex items-start gap-3 md:gap-4">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                    <c.icon className="w-4 h-4 md:w-5 md:h-5 text-primary" />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
            {specialties.map((s, i) => (
              <motion.div
                ...
                className="bg-card rounded-xl md:rounded-2xl p-5 md:p-8 border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-500"
              >
